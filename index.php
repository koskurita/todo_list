      ...
      <div class="panel-body">
        <form method="post" id="to_do_form">
          ...
          <div class = "input-group">
            ...
            <div class="input-group-btn">
              ...
              class = "btn btn-success btn-lg"><span class= "glyphicon 
              glyphicon-plus"></span>
              </button>
            </div>
          </div>
        ...
        <div class="list-group">
          ...
          foreach($result as $row)
          {
            ...
            {
              //if task_status is yes, then draw a line to show it is done
  ...
  $(document).ready(function(){
    ...
    $(document).on('submit', '#to_do_form', function(event){
      ...
      else
      {
        ...
        $.ajax({
          //will send request to this file
          url:"add_task.php",
          method:"POST",
          //convert form date into url encoded form string and send to server
          data:$(this).serialize(),
          //if request completed successfully, and it will recieve data from server
          success:function(data)
          {
            ...
            //clear form field
            $('#to_do_form')[0].reset();
            //display newly added task into list
    ...
    //when you click on particular to do list, this code runs
    $(document).on('click', '.list-group-item', function(){
      //fetch value from id attribute and store on task_list_id
      var task_list_id = $(this).data('id');
      //send task to update_task.php
      $.ajax({
          url:"update_task.php",
          method:"POST",
          data:{task_list_id:task_list_id},
          //runs if data sends successfully
          success:function(data)
        {
          //will draw line through text
    ...
    //when you click on cross, this code executes
    $(document).on('click', '.badge', function(){
      //fetch id and store into task_list_id
      var task_list_id = $(this).data('id');
      $.ajax({
        url:"delete_task.php",
        method:"POST",
